package com.ishuinzu.childside.animation;
...
public class PushDownAnimation implements PushDown {
    @Retention(SOURCE)
    ...
    private PushDownAnimation(final View view) {
    ...
    public static PushDownAnimation setPushDownAnimationTo(final View view) {
        PushDownAnimation pushAnim = new PushDownAnimation(view);
        pushAnim.setOnTouchEvent(null);
        return pushAnim;
    }

    public static PushDownAnimationList setPushDownAnimationTo(View... views) {
        return new PushDownAnimationList(views);
    }
